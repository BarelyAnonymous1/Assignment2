 ...
 *
 */
public class QuadLeafNode<K extends Comparable<K>, E>
{
    ...
    public QuadLeafNode(KVPair<K, E> newPair, int newLeftChild, 
    		int newRightChild, int newLevel)
    {
        ...
        next = (QuadLeafNode<K, E>[]) new QuadLeafNode[newLevel + 1];
